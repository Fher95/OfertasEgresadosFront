...
@NgModule({
  declarations: [ListarSolicitudesEmpresaComponent, PrincipalComponent, ListarOfertasComponent, VerificarExcelComponent, ListarEgresadosAceptadosComponent, SpinnerComponent, ListaEgresadosComponent, FileUploadComponent, GestionApoyosComponent, ListaApoyoComponent, DialogoEditarComponent],
  imports: [
    CommonModule,
    LayoutModule,
    FormsModule,
